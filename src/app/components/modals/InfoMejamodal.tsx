...
// ============================================================
// CONSTANTS — ganti di sini kalau nomor meja / wifi berubah
// ============================================================
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-6">
      ...
      <div className="relative z-10 w-full max-w-[320px] rounded-3xl bg-white p-5 shadow-xl">
        ...
        <button
          onClick={handleSave}
          className="mt-5 w-full rounded-2xl bg-gray-900 py-3 text-sm font-bold text-white active:scale-95 transition-transform"
        >
          Tutup
        </button>
      </div>
